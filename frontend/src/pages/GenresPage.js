...
import LeftLayout from './LeftLayout';
 ...
 function GenresPage() {  
    ...
    const fetchData = async () => {    
        ...
        try{  
            if(platform !== null){ 
                const response = await axios.get(`${process.env.REACT_APP_BACKEND}/api/genres`, {
                    params: {
                      genre:genre, 
                      page:page, 
                      platform:platform 
                ...
                const response = await axios.get(`${process.env.REACT_APP_BACKEND}/api/genresout`, {
                    params: {
                      genre:genre, 
                      page:page, 
    ...
    function slugToTitle(genre) {
        return genre
                              
          .toLowerCase()                          
          .replace(/\b\w/g, char => char.toUpperCase()); 
      } 
      const title = slugToTitle(genre); 
